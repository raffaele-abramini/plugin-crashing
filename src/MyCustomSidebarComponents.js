...
export class MySidebarDashboardButton extends React.Component {
...
export class MyCustomSidebarPage extends React.Component {
...
export class DialerButton extends React.Component {
